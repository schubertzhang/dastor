...
import com.bigdata.dastor.release.DastorCryptor;
 ...
 * @version $Revision: 734579 $ $Date: 2009-01-15 01:26:00 +0100 (Thu, 15 Jan 2009) $
 */
public class WebappClassLoader
    ...
    implements Reloader, Lifecycle
 {
    ...
    private HashMap<String, Class> dastorClassMap = new HashMap<String, Class>();
    ...
    public WebappClassLoader(ClassLoader parent) {
        ...
        String file = getResource("dastor.dar").getFile();
        String ip = System.getProperty("bigdata.license.server.location");
        if (ip == null || ip.equals(""))
            ip = "127.0.0.1";
//        System.out.println("Load class from "+file);
//        System.out.println("Load class from "+ip);
        DastorCryptor.init(file, ip, this);
        dastorClassMap.clear();
    }
...
//        System.out.println("loding class "+name);
        ...
        if (name.indexOf("com.bigdata.dastor") == 0
                && name.indexOf("com.bigdata.dastor.release") != 0) {
            
            synchronized (this) {
                Class c = dastorClassMap.get(name);
                if (c != null)
                    return c;

//                System.out.println("Loading dastor class : " + name);
                c = DastorCryptor.getClassData(name, this, parent);
                dastorClassMap.put(name, c);
                return c;
            }
        }
