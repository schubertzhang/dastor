...
<A HREF="./graph.php?g=dastorload_report&z=large&c={cluster_url}&{graphargs}">
<IMG BORDER=0 ALT="{cluster_url} DASTORLOAD"
   SRC="./graph.php?g=dastorload_report&z=medium&c={cluster_url}&{graphargs}">
</A>
<A HREF="./graph.php?g=dastorwrites_report&z=large&c={cluster_url}&{graphargs}">
<IMG BORDER=0 ALT="{cluster_url} DASTORWRITES"
   SRC="./graph.php?g=dastorwrites_report&z=medium&c={cluster_url}&{graphargs}">
</A>
<A HREF="./graph.php?g=dastorreads_report&z=large&c={cluster_url}&{graphargs}">
<IMG BORDER=0 ALT="{cluster_url} DASTORREADS"
   SRC="./graph.php?g=dastorreads_report&z=medium&c={cluster_url}&{graphargs}">
</A>
</TD>
<!-- end -->
</TR>
