...
#
# Interface definition for Dastor Service
#

namespace java com.bigdata.dastor.thrift
namespace cpp com.bigdata.dastor
namespace csharp Bigdata.Dastor
namespace py dastor
namespace php dastor
namespace perl dastor
...
# Dastor::Dastor::Client.
namespace rb DastorThrift
...
/**
    Methods for fetching rows/records from Dastor will return either a single instance of ColumnOrSuperColumn or a list
...
/**
    ...
    See also <a href="dastor.html#Struct_ColumnPath">ColumnPath</a>
 */
struct ColumnParent {
...
/** The ColumnPath is the path to a single column in Dastor. It might make sense to think of ColumnPath and
...
/**
    ...
    multiple columns. It could be thought of as Dastor's version of LIMIT and ORDER BY
...
/**
    ...
    SlicePredicate's in Dastor are described with either a list of column_names or a SliceRange.  If column_names is
