 ...
 * This is old. 
 * @see com.bigdata.dastor.db.BigdataColumnIndexer
 */
    ...
    private static void doIndexing(AbstractType comparator, Collection<IColumn> columns, DataOutput dos) throws IOException
    {
        ...
        */
        ...
        for (Iterator<IColumn> it = columns.iterator(); it.hasNext();)
        {
            ...
            {
                IndexHelper.IndexInfo cIndexInfo = new IndexHelper.IndexInfo(firstColumn.name(), column.name(), startPosition, endPosition - startPosition, endPosition - startPosition); // BIGDATA: add a parameer (onDiskSize)
