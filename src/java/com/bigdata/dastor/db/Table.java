        ...
        for (String table : tables)
        {
            try 
            {
                ...
                for (ColumnFamilyStore cfStore : cfStores)
                {
                    ...
                    {
                        logger.info("Continue to do unfinished reseting CF: " + SystemTable.kscfName(table, cfStore.getColumnFamilyName()));
            ...
            {
                logger.error("IOException in checkUnfinishedResetingCF : " 
