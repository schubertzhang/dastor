package com.bigdata.dastor.db.commitlog;
/*
 * 
...
public abstract class AbstractCommitLogExecutorService extends AbstractExecutorService implements ICommitLogExecutorService
{
    ...
    protected static void registerMBean(Object o)
    {
        ...
        try
        {
            mbs.registerMBean(o, new ObjectName("com.bigdata.dastor.db:type=Commitlog"));
        }
        catch (Exception e)
        {
    ...
    // dastor is crash-only so there's no need to implement the shutdown methods
