...
{
    // BIGDATA:
    public static class FSInfo implements Serializable
    {
        public String fsName;
        public String mountOn;
    ...
    // BIGDATA:
    public static FSInfo getFSInfo(String fileName) throws IOException, InterruptedException
    {
        Runtime rt = Runtime.getRuntime();
        Process proc = rt.exec("df -PB 1 " + fileName);
        ...
        info.fsName = list.get(0);
        info.mountOn = list.get(5);
        info.totalSize = Double.parseDouble(list.get(1));
        info.usedSize = Double.parseDouble(list.get(2));
        return info;
    }
