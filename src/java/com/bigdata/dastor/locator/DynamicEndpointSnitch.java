...
package com.bigdata.dastor.locator;
...
import com.bigdata.dastor.net.ResponseVerbHandler;
import com.bigdata.dastor.service.StorageService;
import com.bigdata.dastor.utils.AbstractStatsDeque;
import com.bigdata.dastor.locator.IEndPointSnitch;
import com.bigdata.dastor.locator.ILatencyPublisher;
import com.bigdata.dastor.locator.ILatencySubscriber;
import com.bigdata.dastor.locator.AbstractEndpointSnitch;
import com.bigdata.dastor.locator.DynamicEndpointSnitchMBean;
...
public class DynamicEndpointSnitch extends AbstractEndpointSnitch implements ILatencySubscriber, DynamicEndpointSnitchMBean
{
    ...
    public DynamicEndpointSnitch(IEndPointSnitch snitch)
    {
        ...
        try
        {
            mbs.registerMBean(this, new ObjectName("com.bigdata.dastor.locator:type=DynamicEndpointSnitch"));
        }
        catch (Exception e)
        {
