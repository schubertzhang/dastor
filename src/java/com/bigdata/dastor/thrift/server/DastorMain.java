...
import com.bigdata.dastor.config.ConfigurationException;
...
import com.bigdata.dastor.utils.CLibrary;
import com.bigdata.dastor.utils.FBUtilities;

/**
 * This class supports two methods for creating a Dastor node daemon, 
...
public class DastorMain
{
    private static Logger logger = Logger.getLogger(DastorMain.class);
    ...
    public void start()
    {
        logger.info("Dastor starting up...");
        serverEngine.serve();
    }
    ...
    public void stop()
    {
        // this doesn't entirely shut down Dastor, just the Thrift server.
        // jsvc takes care of taking the rest down
        logger.info("Dastor shutting down...");
        serverEngine.stop();
    }
    ...
    public static void main(String[] args)
    {
        ...
        DastorMain daemon = new DastorMain();
        String pidFile = System.getProperty("bigdata.dastor.pid.file");
        ...
        {   
            ...
            if (System.getProperty("bigdata.dastor.foreground") == null)
            {
                System.out.close();
                System.err.close();
            }
