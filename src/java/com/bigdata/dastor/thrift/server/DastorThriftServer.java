...
package com.bigdata.dastor.thrift.server;
...
import com.bigdata.dastor.db.marshal.MarshalException;
...
import com.bigdata.dastor.thrift.AuthenticationException;
import com.bigdata.dastor.thrift.AuthenticationRequest;
import com.bigdata.dastor.thrift.AuthorizationException;
...
import com.bigdata.dastor.thrift.Constants;
import com.bigdata.dastor.thrift.InvalidRequestException;
import com.bigdata.dastor.thrift.KeyRange;
import com.bigdata.dastor.thrift.KeySlice;
import com.bigdata.dastor.thrift.Mutation;
...
import com.bigdata.dastor.thrift.SuperColumn;
import com.bigdata.dastor.thrift.TimedOutException;
import com.bigdata.dastor.thrift.TokenRange;
import com.bigdata.dastor.thrift.UnavailableException;

import static com.bigdata.dastor.thrift.server.ThriftGlue.createColumnOrSuperColumn_Column;
import static com.bigdata.dastor.thrift.server.ThriftGlue.createColumnOrSuperColumn_SuperColumn;

public class DastorThriftServer implements Dastor.Iface
{
    public static String TOKEN_MAP = "token map";
    private static Logger logger = Logger.getLogger(DastorThriftServer.class);
    ...
    throws InvalidRequestException, UnavailableException, TimedOutException
    {
        // !BIGDATA: validate and replace the cf name if necessary
        column_parent.setColumn_family(ThriftValidation.validateUdBucketName(keyspace, column_parent.getColumn_family(), false));
    ...
    {
    	// !BIGDATA: validate and replace the cf name if necessary
        column_path.setColumn_family(ThriftValidation.validateUdBucketName(table, column_path.getColumn_family(), false));
    ...
    throws InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        // !BIGDATA: validate and replace the cf name if necessary 
        column_path.setColumn_family(ThriftValidation.validateUdBucketName(table, column_path.getColumn_family(), true));
    ...
    throws InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        {
            // !BIGDATA: validate and replace the cf name if necessary
            cfName = ThriftValidation.validateUdBucketName(keyspace, cfName, true);
    ...
    throws InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        for (Map.Entry<String, Map<String, List<Mutation>>> mutationEntry: mutation_map.entrySet())
        {
            ...
            for (Map.Entry<String, List<Mutation>> columnFamilyMutations : columnFamilyToMutations.entrySet())
            {
                ...
                // !BIGDATA: validate and replace the cf name if necessary 
                cfName = ThriftValidation.validateUdBucketName(keyspace, cfName, false);
    ...
    protected void checkLoginDone() throws InvalidRequestException
    {
        ...
        // authenticator is AllowAllAuthenticator. This is a temporary measure until issue-714 is complete.
        if (DatabaseDescriptor.getAuthenticator() instanceof AllowAllAuthenticator)
            return;
        if (!loginDone.get()) throw new InvalidRequestException("Login is required before any other API calls");
    }
    
    // main method moved to DastorMain
}
