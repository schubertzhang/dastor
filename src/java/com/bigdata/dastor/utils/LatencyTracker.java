...
public class LatencyTracker
{
    ...
    // BIGDATA
    private long throuputLastOpCount = 0;
    private long throuputLastTimeMs = System.currentTimeMillis();
    ...
    public void addMicro(long micros)
    {
        ...
        // BIGDATA: remove for performance
    ...
    {
        long ops = opCount.get();
        long recentOpCount = ops - throuputLastOpCount;
        throuputLastOpCount = ops;
        long curTimeMs = System.currentTimeMillis();
        long recentTimeMs = curTimeMs - throuputLastTimeMs;
        throuputLastTimeMs = curTimeMs;
        return (recentTimeMs>0)?(double)recentOpCount*1000/recentTimeMs:0;
    }
}
